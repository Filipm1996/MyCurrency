...
fun FavouriteScreen(
    ...
    if (showInfoCurrencyDialogState.value && currencyToShow.value != null) {
        AlertDialog(
            backgroundColor = Color.LightGray,
            onDismissRequest = {
                showInfoCurrencyDialogState.value = false
            ...
            buttons = {
                Column(
                    ...
                    Button(
                        modifier = Modifier.fillMaxWidth(),
                        onClick = { showInfoCurrencyDialogState.value = false }
                    ) {
                        Text("Zamknij")
                    }
                    Button(
                        modifier = Modifier.fillMaxWidth(),
                        onClick = {
                            viewModel.deleteMyCurrencyByName(currencyToShow.value!!)
                            showInfoCurrencyDialogState.value = false
                        }
                    ) {
